...
/** Default framing around origin — grows as furniture unlocks */
export const HOME_BOUNDS_BASE: WorldBounds = {
  minX: PLAYER_ORIGIN.x - 420,
  maxX: PLAYER_ORIGIN.x + 420,
  minY: PLAYER_ORIGIN.y - 300,
  maxY: PLAYER_ORIGIN.y + 220,
};

export const HOME_CONTENT_PADDING = 180;
export const DEFAULT_OBJECT_RADIUS = 110;
export const ORIGIN_ZOOM_INFLUENCE_RADIUS = 900;
export const ORIGIN_CLOSE_ZOOM_RADIUS = 200;
